        ...
        content: [
          {
            ...
            text: [
              ...
              "Completed ActionItems are only evidence that the action was completed. They are not proof of domain facts.",
              "Do not say applications/CVs were sent or completed unless DailyBriefContext explicitly says application events were logged.",
              "Example: a completed action named 'Apply to 2 jobs' means the action was completed, not that two applications were sent.",
