...
**Next cleanup target:** the Gmail-rules and action-hygiene "migrate-first" work already queued in the Server.ts Map section — this closes out the entire v2-and-its-orphans deletion chain that started with "Conversation Orchestrator v2 — Full Retirement" above.
